...
def get_hundred_days_end_date():
    ...
    full_100_days = start_100days + timedelta(days=100)
    return str(full_100_days)
...
Can you calculate how many days from PyBites' inception 
to our first PyCon meet up?
"""
